...
use super::ArtifactsManager;

pub struct RecursionTipArtifactsManager;

#[async_trait]
impl ArtifactsManager for RecursionTipArtifactsManager {
    type InputMetadata = Vec<(u8, u32)>;
    type InputArtifacts = Vec<ZkSyncRecursionProof>;
    type OutputArtifacts = ZkSyncRecursiveLayerCircuit;
    ...
    async fn save_to_bucket(
        ...
        object_store
            .put(key, &CircuitWrapper::Recursive(artifacts.clone()))
            .await
            .unwrap()
    }
